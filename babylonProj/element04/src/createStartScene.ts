...
//-------------------------------------
 ...
 // let keyDownMap: any[] = [];
  ...
  //     //physics collision
  //     item = mesh;
  //     let playerAggregate = new PhysicsAggregate(item, PhysicsShapeType.CAPSULE, { mass: 1}, scene);
  ...
  //  subdivisions: 4});
  //   const groundAggregate = new PhysicsAggregate(ground, PhysicsShapeType.BOX, { mass: 1}, 
  //  scene);
  //   return ground; 
  //  }
